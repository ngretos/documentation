...
| minForeignRows| number| Στον έλεγχο ορθότητας ελέγχεται αν υπάρχουν τουλάχιστον τόσες καταχωρήσεις αν φορέα| Μόνο στα CallData|
| maxForeignRows| number| Στον έλεγχο ορθότητας ελέγχεται αν υπάρχουν το πολύ τόσες καταχωρήσεις αν φορέα| Μόνο στα CallData|
...
| hidden| text | Αν "1" το πεδίο δεν εμφανίζεται, τα δεδομένα που περιέχει μεταφρονται στον browser| Αν θέλουμε να κρύψουμε ένα πεδίο χρησιμοποιούμε το edit view ""|
